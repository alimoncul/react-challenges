...
function ProgressBar(props?: { difficulty?: string }): JSX.Element {
    ...
    const inputPercentageHandler = (e: React.FormEvent<HTMLInputElement>) => {
        const transformedInt = e.currentTarget.value ? parseInt(e.currentTarget.value) : 0;
            ...
            <header className="App-header">
                ...
                <div className='d-flex flex-wrap'>
                    <div className='d-flex w-100'>
                        <input className="form-control m-1" value={input} placeholder="Percentage" aria-label="Percentage" type="number" onChange={inputPercentageHandler} />
                    </div>
                    <div className='d-flex w-100'>
                        <progress className='w-100' id="file" value={input} max="100">{input}%</progress>
                    </div>
                </div>
            </header>
        </div>
